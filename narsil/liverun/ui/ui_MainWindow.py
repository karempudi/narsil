...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.writeSetupButton = QPushButton(self.Setup)
        self.writeSetupButton.setObjectName(u"writeSetupButton")
        self.writeSetupButton.setGeometry(QRect(10, 110, 89, 25))
        self.loadSetupButton = QPushButton(self.Setup)
        self.loadSetupButton.setObjectName(u"loadSetupButton")
        self.loadSetupButton.setGeometry(QRect(110, 30, 89, 25))
        ...
        self.stopPlotsButton = QPushButton(self.groupBox_3)
        self.stopPlotsButton.setObjectName(u"stopPlotsButton")
        self.stopPlotsButton.setGeometry(QRect(20, 70, 131, 27))
        self.startPlotsButton = QPushButton(self.groupBox_3)
        self.startPlotsButton.setObjectName(u"startPlotsButton")
        self.startPlotsButton.setGeometry(QRect(20, 30, 131, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.writeSetupButton.setText(QCoreApplication.translate("MainWindow", u"Write", None))
        self.loadSetupButton.setText(QCoreApplication.translate("MainWindow", u"Load", None))
        ...
        self.stopPlotsButton.setText(QCoreApplication.translate("MainWindow", u"Stop Plots", None))
        self.startPlotsButton.setText(QCoreApplication.translate("MainWindow", u"Start Plots", None))
