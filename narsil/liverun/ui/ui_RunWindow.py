...
class Ui_runWindow(object):
    def setupUi(self, runWindow):
        ...
        self.loadButton.setGeometry(QRect(10, 30, 89, 25))
        self.runButton = QPushButton(self.centralwidget)
        self.runButton.setObjectName(u"runButton")
        self.runButton.setGeometry(QRect(240, 30, 89, 25))
        self.stopButton = QPushButton(self.centralwidget)
        self.stopButton.setObjectName(u"stopButton")
        self.stopButton.setGeometry(QRect(340, 30, 89, 25))
        self.makeFilesButton = QPushButton(self.centralwidget)
        self.makeFilesButton.setObjectName(u"makeFilesButton")
        self.makeFilesButton.setGeometry(QRect(120, 30, 101, 25))
    ...
    def retranslateUi(self, runWindow):
        ...
        self.makeFilesButton.setText(QCoreApplication.translate("runWindow", u"Allocate Files", None))
    # retranslateUi
